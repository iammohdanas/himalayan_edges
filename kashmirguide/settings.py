"""
Django settings for kashmirguide project.
...
SECRET_KEY = 'django-insecure-!t_ingssgoo=t+&i4crce4@ohxzd^126&yji%04f0q4^+kt7o9'
...
ROOT_URLCONF = 'kashmirguide.urls'
...
WSGI_APPLICATION = 'kashmirguide.wsgi.application'
